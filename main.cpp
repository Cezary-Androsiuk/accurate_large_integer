...
int main(){
    ...
    // y.assignment_str("b10000000000000000000000000000000000000000000000000000111111111111111110000000000000011111111111111111111111000000000000000000111111101010101010101011001000");
    // x = 100;
    y = 2;
